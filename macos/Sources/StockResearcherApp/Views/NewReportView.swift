...
struct NewReportView: View {
  ...
  @State private var mode =
    UserDefaults.standard.string(forKey: PreferenceKeys.defaultMode)
    ?? AppDefaults.defaultMode
  @State private var webSearch = UserDefaults.standard.bool(forKey: PreferenceKeys.defaultWebSearch)
  @State private var maxResults = UserDefaults.standard.integer(
    forKey: PreferenceKeys.defaultMaxResults)
  ...
  private func generate() {
    ...
    isPresented = false
    Task { _ = await store.submitReport(request) }
  }
}
